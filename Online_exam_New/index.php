...
<div class="header">
    <div class="row">
        ...
        <div class="col-md-2 col-md-offset-3">
            <a href="../index.php" class="pull-right btn sub1"><span
                    class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;<span
                    class="title1"><b>Home</b></span></a>
		</div>
		<div class="col-md-1">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <img src="image/images.jpg" width=100 height=100 alt="BUBT"
                             class="img-rounded">
                    </div>
                    <div class="col-md-5">
                        <a href="https://www.facebook.com/raman"
                           style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Ramananda
                            Sarkar And Md. Shapiqul Islam</a>
                        <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">
                            +8801920-380365</h4>
                        <h4 style="font-family:'typo' ">cserama.tpi@gmail.com</h4>
                        <h4 style="font-family:'typo' ">Bangladesh University Of Business & Technology</h4></div>
                </div>
                </p>
            </div>
